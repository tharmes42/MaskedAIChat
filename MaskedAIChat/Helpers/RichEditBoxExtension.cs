...
namespace MaskedAIChat.Helpers;

// Extension class to allow binding to the plain text of a RichEditBox
// thanks to https://stackoverflow.com/questions/49102980/how-can-i-databind-to-the-plain-text-value-of-a-richeditbox-in-uwp
public class RichEditBoxExtension
{
      ...
      DependencyPropertyChangedEventArgs e)
    {
        ...
        switch (state)
        {
            case RichEditChangeState.Idle:
                ...
                source.Document.SetText(Microsoft.UI.Text.TextSetOptions.None, text);
                break;
    ...
    {
        public RichEditChangeState State
        {
            get; set;
        }
    }
